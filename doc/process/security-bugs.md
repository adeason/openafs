...
We would like to know when a security bug is found so that it can be fixed and
disclosed as quickly as possible.  Please report security bugs to the OpenAFS
security team.

## How to report a security bug

If you suspect you have discovered a security bug, please report it to the
OpenAFS security officer at <security@openafs.org>. Please encrypted sensitive
information with PGP (GPG) when sending it. Either use an email client which
has PGP capabilities or encrypt the contents before sending.
